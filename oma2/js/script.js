(function (factory) {
	...
	var swiperBundle_min = createCommonjsModule(function (module, exports) {
	/**
	 * Swiper 8.4.4
	...
	function swiperConstructor(element, pagination, navigation, slidesPerView, spaceBetween, sliderPerViewMobile, autoplay = 5000) {
	  ...
	  new swiperBundle_min("." + element, options);
	}
	...
	function goodItemSwiper() {
	  ...
	  var swiperGood = new swiperBundle_min(".good-item-swiper", {
	    loop: true,
	    direction: 'vertical',
	    spaceBetween: 50,
	    slidesPerView: 1,
